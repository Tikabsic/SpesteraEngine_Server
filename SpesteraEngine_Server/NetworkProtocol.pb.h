...
constexpr Wrapper_MessageType Wrapper_MessageType_MessageType_MAX = static_cast<Wrapper_MessageType>(5);
constexpr int Wrapper_MessageType_MessageType_ARRAYSIZE = 5 + 1;
