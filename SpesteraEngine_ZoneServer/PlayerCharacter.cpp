...
PlayerCharacter::PlayerCharacter(float X, float Y, float Z, float movement_speed, uint16_t RY, uint16_t pid)
{
...
void PlayerCharacter::move_player_character(PlayerPosition transform)
{
...
float PlayerCharacter::get_player_movement_speed()
{
    return player_movement_speed;
}

bool PlayerCharacter::is_character_moving()
{
...
void PlayerCharacter::set_last_sent_position()
{
