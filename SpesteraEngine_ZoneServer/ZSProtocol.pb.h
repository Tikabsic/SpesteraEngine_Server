...
#ifndef GOOGLE_PROTOBUF_INCLUDED_ZSProtocol_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_ZSProtocol_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_ZSProtocol_2eproto
...
struct TableStruct_ZSProtocol_2eproto {
  static const ::uint32_t offsets[];
};
extern const ::google::protobuf::internal::DescriptorTable
    descriptor_table_ZSProtocol_2eproto;
class AnimationClip;
...
extern AssignCharacterDefaultTypeInternal _AssignCharacter_default_instance_;
class Heartbeat;
...
extern PlayerInDefaultTypeInternal _PlayerIn_default_instance_;
...
extern RequestWorldDataDefaultTypeInternal _RequestWorldData_default_instance_;
class WorldData;
...
extern ZSWrapperDefaultTypeInternal _ZSWrapper_default_instance_;
namespace google {
namespace protobuf {
}  // namespace protobuf
}  // namespace google

enum ZSWrapper_MessageType : int {
  ZSWrapper_MessageType_WORLDDATA = 0,
  ZSWrapper_MessageType_ASSIGNCHARACTER = 1,
  ZSWrapper_MessageType_PLAYERINITIALDATA = 4,
  ZSWrapper_MessageType_PLAYERPOSITION = 5,
  ZSWrapper_MessageType_HEARTBEAT = 6,
  ZSWrapper_MessageType_REQUESTWORLDDATA = 98,
  ZSWrapper_MessageType_PLAYERIN = 99,
  ZSWrapper_MessageType_PLAYEROUT = 100,
  ZSWrapper_MessageType_ZSWrapper_MessageType_INT_MIN_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::int32_t>::min(),
  ZSWrapper_MessageType_ZSWrapper_MessageType_INT_MAX_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::int32_t>::max(),
};

bool ZSWrapper_MessageType_IsValid(int value);
extern const uint32_t ZSWrapper_MessageType_internal_data_[];
constexpr ZSWrapper_MessageType ZSWrapper_MessageType_MessageType_MIN = static_cast<ZSWrapper_MessageType>(0);
constexpr ZSWrapper_MessageType ZSWrapper_MessageType_MessageType_MAX = static_cast<ZSWrapper_MessageType>(100);
constexpr int ZSWrapper_MessageType_MessageType_ARRAYSIZE = 100 + 1;
const ::google::protobuf::EnumDescriptor*
ZSWrapper_MessageType_descriptor();
template <typename T>
const std::string& ZSWrapper_MessageType_Name(T value) {
  static_assert(std::is_same<T, ZSWrapper_MessageType>::value ||
                    std::is_integral<T>::value,
                "Incorrect type passed to MessageType_Name().");
  return ::google::protobuf::internal::NameOfEnum(ZSWrapper_MessageType_descriptor(), value);
}
inline bool ZSWrapper_MessageType_Parse(absl::string_view name, ZSWrapper_MessageType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ZSWrapper_MessageType>(
      ZSWrapper_MessageType_descriptor(), name, value);
}
...
class ZSWrapper final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ZSWrapper) */ {
 public:
  inline ZSWrapper() : ZSWrapper(nullptr) {}
  ~ZSWrapper() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR ZSWrapper(::google::protobuf::internal::ConstantInitialized);

  inline ZSWrapper(const ZSWrapper& from)
      : ZSWrapper(nullptr, from) {}
  ZSWrapper(ZSWrapper&& from) noexcept
    : ZSWrapper() {
    *this = ::std::move(from);
  }

  inline ZSWrapper& operator=(const ZSWrapper& from) {
    CopyFrom(from);
    return *this;
  }
  inline ZSWrapper& operator=(ZSWrapper&& from) noexcept {
  ...
  static const ZSWrapper& default_instance() {
    return *internal_default_instance();
  }
  static inline const ZSWrapper* internal_default_instance() {
    return reinterpret_cast<const ZSWrapper*>(
               &_ZSWrapper_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    0;

  friend void swap(ZSWrapper& a, ZSWrapper& b) {
    a.Swap(&b);
  }
  inline void Swap(ZSWrapper* other) {
  ...
  void UnsafeArenaSwap(ZSWrapper* other) {
    if (other == this) return;
  ...
  ZSWrapper* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ZSWrapper>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const ZSWrapper& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom( const ZSWrapper& from) {
    ZSWrapper::MergeImpl(*this, from);
  }
  private:
  ...
  void SharedDtor();
  void InternalSwap(ZSWrapper* other);
  ...
  protected:
  explicit ZSWrapper(::google::protobuf::Arena* arena);
  ZSWrapper(::google::protobuf::Arena* arena, const ZSWrapper& from);
  public:
  ...
  using MessageType = ZSWrapper_MessageType;
  static constexpr MessageType WORLDDATA = ZSWrapper_MessageType_WORLDDATA;
  static constexpr MessageType ASSIGNCHARACTER = ZSWrapper_MessageType_ASSIGNCHARACTER;
  static constexpr MessageType PLAYERINITIALDATA = ZSWrapper_MessageType_PLAYERINITIALDATA;
  static constexpr MessageType PLAYERPOSITION = ZSWrapper_MessageType_PLAYERPOSITION;
  static constexpr MessageType HEARTBEAT = ZSWrapper_MessageType_HEARTBEAT;
  static constexpr MessageType REQUESTWORLDDATA = ZSWrapper_MessageType_REQUESTWORLDDATA;
  static constexpr MessageType PLAYERIN = ZSWrapper_MessageType_PLAYERIN;
  static constexpr MessageType PLAYEROUT = ZSWrapper_MessageType_PLAYEROUT;
  static inline bool MessageType_IsValid(int value) {
    return ZSWrapper_MessageType_IsValid(value);
  }
  static constexpr MessageType MessageType_MIN = ZSWrapper_MessageType_MessageType_MIN;
  static constexpr MessageType MessageType_MAX = ZSWrapper_MessageType_MessageType_MAX;
  static constexpr int MessageType_ARRAYSIZE = ZSWrapper_MessageType_MessageType_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor* MessageType_descriptor() {
    return ZSWrapper_MessageType_descriptor();
  }
  template <typename T>
  static inline const std::string& MessageType_Name(T value) {
    return ZSWrapper_MessageType_Name(value);
  }
  static inline bool MessageType_Parse(absl::string_view name, MessageType* value) {
    return ZSWrapper_MessageType_Parse(name, value);
  }
  ...
  void clear_type() ;
  ::ZSWrapper_MessageType type() const;
  void set_type(::ZSWrapper_MessageType value);

  private:
  ::ZSWrapper_MessageType _internal_type() const;
  void _internal_set_type(::ZSWrapper_MessageType value);

  public:
  // @@protoc_insertion_point(class_scope:ZSWrapper)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_ZSProtocol_2eproto;
};// -------------------------------------------------------------------

class RequestWorldData final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:RequestWorldData) */ {
 public:
  inline RequestWorldData() : RequestWorldData(nullptr) {}
  ~RequestWorldData() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR RequestWorldData(::google::protobuf::internal::ConstantInitialized);

  inline RequestWorldData(const RequestWorldData& from)
      : RequestWorldData(nullptr, from) {}
  RequestWorldData(RequestWorldData&& from) noexcept
    : RequestWorldData() {
    *this = ::std::move(from);
  }

  inline RequestWorldData& operator=(const RequestWorldData& from) {
    CopyFrom(from);
    return *this;
  }
  inline RequestWorldData& operator=(RequestWorldData&& from) noexcept {
    if (this == &from) return *this;
    if (GetArena() == from.GetArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetArena() != nullptr
  ...
  static const RequestWorldData& default_instance() {
    return *internal_default_instance();
  }
  static inline const RequestWorldData* internal_default_instance() {
    return reinterpret_cast<const RequestWorldData*>(
               &_RequestWorldData_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(RequestWorldData& a, RequestWorldData& b) {
    a.Swap(&b);
  }
  inline void Swap(RequestWorldData* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetArena() != nullptr &&
        GetArena() == other->GetArena()) {
  ...
  void UnsafeArenaSwap(RequestWorldData* other) {
    if (other == this) return;
    ABSL_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  RequestWorldData* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<RequestWorldData>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const RequestWorldData& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom( const RequestWorldData& from) {
    RequestWorldData::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg);
  public:
  ...
  void SharedCtor(::google::protobuf::Arena* arena);
  void SharedDtor();
  void InternalSwap(RequestWorldData* other);
  ...
  protected:
  explicit RequestWorldData(::google::protobuf::Arena* arena);
  RequestWorldData(::google::protobuf::Arena* arena, const RequestWorldData& from);
  public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:RequestWorldData)
 private:
  class _Internal;
...
class PlayerOut final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:PlayerOut) */ {
 public:
  inline PlayerOut() : PlayerOut(nullptr) {}
  ~PlayerOut() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR PlayerOut(::google::protobuf::internal::ConstantInitialized);

  inline PlayerOut(const PlayerOut& from)
      : PlayerOut(nullptr, from) {}
  PlayerOut(PlayerOut&& from) noexcept
    : PlayerOut() {
    *this = ::std::move(from);
  }
  ...
  inline PlayerOut& operator=(PlayerOut&& from) noexcept {
    if (this == &from) return *this;
    if (GetArena() == from.GetArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetArena() != nullptr
  ...
  friend void swap(PlayerOut& a, PlayerOut& b) {
    a.Swap(&b);
  }
  inline void Swap(PlayerOut* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetArena() != nullptr &&
        GetArena() == other->GetArena()) {
  ...
  void UnsafeArenaSwap(PlayerOut* other) {
    if (other == this) return;
    ABSL_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  PlayerOut* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<PlayerOut>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const PlayerOut& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom( const PlayerOut& from) {
    PlayerOut::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg);
  public:
  ...
  protected:
  explicit PlayerOut(::google::protobuf::Arena* arena);
  PlayerOut(::google::protobuf::Arena* arena, const PlayerOut& from);
  public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:PlayerOut)
 private:
  class _Internal;
...
class AssignCharacter final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:AssignCharacter) */ {
 public:
  inline AssignCharacter() : AssignCharacter(nullptr) {}
  ~AssignCharacter() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR AssignCharacter(::google::protobuf::internal::ConstantInitialized);

  inline AssignCharacter(const AssignCharacter& from)
      : AssignCharacter(nullptr, from) {}
  AssignCharacter(AssignCharacter&& from) noexcept
    : AssignCharacter() {
    *this = ::std::move(from);
  }

  inline AssignCharacter& operator=(const AssignCharacter& from) {
    CopyFrom(from);
    return *this;
  }
  inline AssignCharacter& operator=(AssignCharacter&& from) noexcept {
    if (this == &from) return *this;
    if (GetArena() == from.GetArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetArena() != nullptr
  ...
  static const AssignCharacter& default_instance() {
    return *internal_default_instance();
  }
  static inline const AssignCharacter* internal_default_instance() {
    return reinterpret_cast<const AssignCharacter*>(
               &_AssignCharacter_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(AssignCharacter& a, AssignCharacter& b) {
    a.Swap(&b);
  }
  inline void Swap(AssignCharacter* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetArena() != nullptr &&
        GetArena() == other->GetArena()) {
  ...
  void UnsafeArenaSwap(AssignCharacter* other) {
    if (other == this) return;
    ABSL_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  AssignCharacter* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<AssignCharacter>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const AssignCharacter& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom( const AssignCharacter& from) {
    AssignCharacter::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg);
  public:
  ...
  void SharedCtor(::google::protobuf::Arena* arena);
  void SharedDtor();
  void InternalSwap(AssignCharacter* other);

  private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "AssignCharacter";
  }
  protected:
  explicit AssignCharacter(::google::protobuf::Arena* arena);
  AssignCharacter(::google::protobuf::Arena* arena, const AssignCharacter& from);
  public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:AssignCharacter)
 private:
  class _Internal;
...
class PlayerIn final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:PlayerIn) */ {
 public:
  inline PlayerIn() : PlayerIn(nullptr) {}
  ~PlayerIn() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR PlayerIn(::google::protobuf::internal::ConstantInitialized);

  inline PlayerIn(const PlayerIn& from)
      : PlayerIn(nullptr, from) {}
  PlayerIn(PlayerIn&& from) noexcept
    : PlayerIn() {
    *this = ::std::move(from);
  }

  inline PlayerIn& operator=(const PlayerIn& from) {
    CopyFrom(from);
    return *this;
  }
  inline PlayerIn& operator=(PlayerIn&& from) noexcept {
    if (this == &from) return *this;
    if (GetArena() == from.GetArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetArena() != nullptr
  ...
  static const PlayerIn& default_instance() {
    return *internal_default_instance();
  }
  static inline const PlayerIn* internal_default_instance() {
    return reinterpret_cast<const PlayerIn*>(
               &_PlayerIn_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(PlayerIn& a, PlayerIn& b) {
    a.Swap(&b);
  }
  inline void Swap(PlayerIn* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetArena() != nullptr &&
        GetArena() == other->GetArena()) {
  ...
  void UnsafeArenaSwap(PlayerIn* other) {
    if (other == this) return;
    ABSL_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  PlayerIn* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<PlayerIn>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const PlayerIn& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom( const PlayerIn& from) {
    PlayerIn::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg);
  public:
  ...
  void SharedCtor(::google::protobuf::Arena* arena);
  void SharedDtor();
  void InternalSwap(PlayerIn* other);
  ...
  protected:
  explicit PlayerIn(::google::protobuf::Arena* arena);
  PlayerIn(::google::protobuf::Arena* arena, const PlayerIn& from);
  public:
  ...
  bool has_data() const;
  void clear_data() ;
  const ::PlayerInitialData& data() const;
  PROTOBUF_NODISCARD ::PlayerInitialData* release_data();
  ::PlayerInitialData* mutable_data();
  void set_allocated_data(::PlayerInitialData* value);
  void unsafe_arena_set_allocated_data(::PlayerInitialData* value);
  ::PlayerInitialData* unsafe_arena_release_data();

  private:
  const ::PlayerInitialData& _internal_data() const;
  ::PlayerInitialData* _internal_mutable_data();

  public:
  // @@protoc_insertion_point(class_scope:PlayerIn)
 private:
  class _Internal;
...
// .ZSWrapper.MessageType type = 1;
inline void ZSWrapper::clear_type() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.type_ = 0;
}
inline ::ZSWrapper_MessageType ZSWrapper::type() const {
  // @@protoc_insertion_point(field_get:ZSWrapper.type)
  return _internal_type();
}
inline void ZSWrapper::set_type(::ZSWrapper_MessageType value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:ZSWrapper.type)
}
inline ::ZSWrapper_MessageType ZSWrapper::_internal_type() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return static_cast<::ZSWrapper_MessageType>(_impl_.type_);
}
inline void ZSWrapper::_internal_set_type(::ZSWrapper_MessageType value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.type_ = value;
}
...
// bytes payload = 2;
inline void ZSWrapper::clear_payload() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.payload_.ClearToEmpty();
}
inline const std::string& ZSWrapper::payload() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:ZSWrapper.payload)
  return _internal_payload();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void ZSWrapper::set_payload(Arg_&& arg,
                                                     Args_... args) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.payload_.SetBytes(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:ZSWrapper.payload)
}
inline std::string* ZSWrapper::mutable_payload() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_payload();
  // @@protoc_insertion_point(field_mutable:ZSWrapper.payload)
  return _s;
}
inline const std::string& ZSWrapper::_internal_payload() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.payload_.Get();
}
inline void ZSWrapper::_internal_set_payload(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.payload_.Set(value, GetArena());
}
inline std::string* ZSWrapper::_internal_mutable_payload() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  return _impl_.payload_.Mutable( GetArena());
}
inline std::string* ZSWrapper::release_payload() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:ZSWrapper.payload)
  return _impl_.payload_.Release();
}
inline void ZSWrapper::set_allocated_payload(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ...
  // @@protoc_insertion_point(field_set_allocated:ZSWrapper.payload)
}
...
// uint32 player_id = 1;
inline void RequestWorldData::clear_player_id() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.player_id_ = 0u;
}
inline ::uint32_t RequestWorldData::player_id() const {
  // @@protoc_insertion_point(field_get:RequestWorldData.player_id)
  return _internal_player_id();
}
inline void RequestWorldData::set_player_id(::uint32_t value) {
  _internal_set_player_id(value);
  // @@protoc_insertion_point(field_set:RequestWorldData.player_id)
}
inline ::uint32_t RequestWorldData::_internal_player_id() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.player_id_;
}
inline void RequestWorldData::_internal_set_player_id(::uint32_t value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
...
// string secret_key = 1;
inline void AssignCharacter::clear_secret_key() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.secret_key_.ClearToEmpty();
}
inline const std::string& AssignCharacter::secret_key() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:AssignCharacter.secret_key)
  return _internal_secret_key();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void AssignCharacter::set_secret_key(Arg_&& arg,
                                                     Args_... args) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.secret_key_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:AssignCharacter.secret_key)
}
inline std::string* AssignCharacter::mutable_secret_key() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_secret_key();
  // @@protoc_insertion_point(field_mutable:AssignCharacter.secret_key)
  return _s;
}
inline const std::string& AssignCharacter::_internal_secret_key() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.secret_key_.Get();
}
inline void AssignCharacter::_internal_set_secret_key(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.secret_key_.Set(value, GetArena());
}
inline std::string* AssignCharacter::_internal_mutable_secret_key() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  return _impl_.secret_key_.Mutable( GetArena());
}
inline std::string* AssignCharacter::release_secret_key() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:AssignCharacter.secret_key)
  return _impl_.secret_key_.Release();
}
inline void AssignCharacter::set_allocated_secret_key(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:AssignCharacter.secret_key)
}
...
// .PlayerInitialData data = 1;
inline bool PlayerIn::has_data() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || _impl_.data_ != nullptr);
  return value;
}
inline void PlayerIn::clear_data() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (_impl_.data_ != nullptr) _impl_.data_->Clear();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const ::PlayerInitialData& PlayerIn::_internal_data() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  const ::PlayerInitialData* p = _impl_.data_;
  return p != nullptr ? *p : reinterpret_cast<const ::PlayerInitialData&>(::_PlayerInitialData_default_instance_);
}
inline const ::PlayerInitialData& PlayerIn::data() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:PlayerIn.data)
  return _internal_data();
}
inline void PlayerIn::unsafe_arena_set_allocated_data(::PlayerInitialData* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.data_);
  }
  _impl_.data_ = reinterpret_cast<::PlayerInitialData*>(value);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000001u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:PlayerIn.data)
}
inline ::PlayerInitialData* PlayerIn::release_data() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);

  _impl_._has_bits_[0] &= ~0x00000001u;
  ::PlayerInitialData* released = _impl_.data_;
...
inline ::PlayerInitialData* PlayerIn::unsafe_arena_release_data() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:PlayerIn.data)

  _impl_._has_bits_[0] &= ~0x00000001u;
  ::PlayerInitialData* temp = _impl_.data_;
  _impl_.data_ = nullptr;
  return temp;
}
inline ::PlayerInitialData* PlayerIn::_internal_mutable_data() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000001u;
  if (_impl_.data_ == nullptr) {
    auto* p = CreateMaybeMessage<::PlayerInitialData>(GetArena());
    _impl_.data_ = reinterpret_cast<::PlayerInitialData*>(p);
  }
  return _impl_.data_;
}
inline ::PlayerInitialData* PlayerIn::mutable_data() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::PlayerInitialData* _msg = _internal_mutable_data();
  // @@protoc_insertion_point(field_mutable:PlayerIn.data)
  return _msg;
}
inline void PlayerIn::set_allocated_data(::PlayerInitialData* value) {
  ::google::protobuf::Arena* message_arena = GetArena();
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::PlayerInitialData*>(_impl_.data_);
  }
  ...
  _impl_.data_ = reinterpret_cast<::PlayerInitialData*>(value);
  // @@protoc_insertion_point(field_set_allocated:PlayerIn.data)
}
...
// uint32 player_id = 1;
inline void PlayerOut::clear_player_id() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.player_id_ = 0u;
}
inline ::uint32_t PlayerOut::player_id() const {
  // @@protoc_insertion_point(field_get:PlayerOut.player_id)
  return _internal_player_id();
}
inline void PlayerOut::set_player_id(::uint32_t value) {
  _internal_set_player_id(value);
  // @@protoc_insertion_point(field_set:PlayerOut.player_id)
}
inline ::uint32_t PlayerOut::_internal_player_id() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.player_id_;
}
inline void PlayerOut::_internal_set_player_id(::uint32_t value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.player_id_ = value;
}
...
template <>
struct is_proto_enum<::ZSWrapper_MessageType> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::ZSWrapper_MessageType>() {
  return ::ZSWrapper_MessageType_descriptor();
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_ZSProtocol_2eproto_2epb_2eh
